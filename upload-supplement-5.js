...
const attorneys = JSON.parse(fs.readFileSync('./california-attorneys-supplement-5.json', 'utf8'));

console.log(`📋 Loaded ${attorneys.length} additional California estate planning attorneys`);
